 ...
 * @author mirko
 */
@WebServlet(name = "RimozioneRegistratiServlet", urlPatterns = {"/RimozioneRegistratiServlet"})
public class RimozioneRegistratiServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(manUtenti.eliminaRegistrati(email) == false){
