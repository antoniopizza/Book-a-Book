 ...
 * @author mirko
 */
@WebServlet(name = "ConfermaRestituzioneLibroServlet", urlPatterns = {"/prenotazioni/conferma-restituzione"})
public class ConfermaRestituzioneLibroServlet extends HttpServlet {
