<% String templatePath = application.getContextPath() + "/template/"; %>
...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<%= templatePath %>css/sb-admin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<%= templatePath %>css/plugins/morris.css" rel="stylesheet">
